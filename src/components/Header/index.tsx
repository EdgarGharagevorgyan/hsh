  ...
  return (
    <header className={styles.headerContainer}>
      ...
      <div className={styles.headerBody}>
        ...
        <h2>
          HSH Furnitures-ը բացահայտում է ժամանակակից դիզայնի նոր հայեցակարգերը, որոնք միավորում են
          ոճը, որակը և ֆունկցիոնալությունը։ Մենք հավատում ենք, որ յուրաքանչյուր կահույք պետք է լինի
          ոչ միայն գեղեցիկ, այլև հարմարավետ ու երկարատև։ Ստեղծեք ձեր կատարյալ միջավայրը մեզ հետ,
          որտեղ յուրաքանչյուր մանրուք խոսում է հանգստի և ճաշակի մասին։
        </h2>
        <span className={styles.line}></span>
      </div>
    </header>
